    ...
    for(let i=0; i<events.length; i++){
        ...
        if (event.status !== "ended" && event.status !== "draft"){
            ...
            <div class="timeline-row">
                <div class="timeline-block ${event.deadline ? '' : "no-deadline-timeline"}" style="width:${width}rem; ${event.deadline ? `background-color: ${brandingColors[(i%8)]}` : `background: linear-gradient(90deg, ${brandingColors[(i%8)]} 40%, var(--timeline-background) 95%);`}">
